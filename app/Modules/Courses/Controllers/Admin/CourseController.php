...
class CourseController extends \App\CRMDV\Controllers\Admin\CURDBaseController
{
    ...
    protected $module = [
        ...
        'modal' => '\App\Modules\Courses\Models\Course',
        'list' => [
    ...
    public function view(Request $request, $id)
    {
        ...
        return view('Course.Admin.course.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('Course.Admin.course.add')->with($data);
            } else if ($_POST) {
...
//            if (!is_object($item)) abort(404);
            if (!$_POST) {
                ...
                return view('Course.Admin.course.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
