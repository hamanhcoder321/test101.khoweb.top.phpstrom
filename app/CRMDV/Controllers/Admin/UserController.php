...
class UserController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'email', 'type' => 'custom', 'field' => 'CRMDV.admin.form.email', 'class' => '', 'label' => 'admin.email', 'group_class' => 'col-md-4'],
                ['name' => 'tel', 'type' => 'custom', 'class' => 'required', 'field' => 'CRMDV.user.form.tel', 'label' => 'admin.phone', 'group_class' => 'col-md-4'],
            ...
            'more_info_tab' => [
                ...
                ['name' => 'image', 'type' => 'file_editor', 'label' => 'Ảnh đại diện', 'count' => 4],
    ...
    public function getIndex(Request $request)
    {
        ...
        /*$kh = RoleAdmin::whereIn('role_id', [3,4])->pluck('admin_id')->toArray();
        User::whereNotIn('id', $kh)->delete();
        ...
        return view('CRMDV.user.list')->with($data);
    }

    public function appendWhere($query, $request)
    {

        //  Chỉ truy vấn ra các KH của mình
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMDV.user.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMDV.user.edit')->with($data);
            } else if ($_POST) {
