    ...
    <div class="kt-form">
        <div class="kt-portlet__body">
            <div class="kt-section kt-section--first">
                ...
                <?php 
                $field = ['name' => 'finance_detail', 'type' => 'textarea', 'label' => 'Chi tiết hạng mục tiền', 'class' => 'required', 'group_class' => 'col-md-12', 'value' => isset($result) ? @$result->bill_finance->detail : '', 'inner' => 'placeholder="'.trans('CRMWoo_admin.chi_tiet_hang_muc_tien_noi_dung').'"'];
                ?>
                <div class="form-group-div form-group {{ @$field['group_class'] }}"
                     id="form-group-{{ $field['name'] }}">
                    <label for="{{ $field['name'] }}">{{ @$field['label'] }} @if(strpos(@$field['class'], 'require') !== false)
