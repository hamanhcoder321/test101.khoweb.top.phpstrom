                    ...
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <button type="button" class="btn btn-info btn-icon-sm ">
                                <i class="flaticon-refresh"></i> {{trans('admin.reset_wait')}}
                            </button>
                            <button type="button" class="btn btn-success btn-icon-sm ">
                                <i class="flaticon2-checkmark"></i> {{trans('admin.active')}}
                            </button>
                            <button type="button" class="btn btn-danger btn-icon-sm">
                                <i class="flaticon2-delete"></i> {{trans('admin.pause')}}
                            </button>
                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--scroll kt-datatable--loaded"
                    ...
                    <div class="kt-datatable__pager kt-datatable--paging-loaded">
                        ...
                        <div class="kt-datatable__pager-info">
                            ...
                            <span class="kt-datatable__pager-detail">{{trans('admin.display')}} {{ (($page - 1) * $limit) + 1 }} - {{ ($page * $limit) < $record_total ? ($page * $limit) : $record_total }} {{trans('admin.of_the')}} {{ @$record_total }}</span>
                        </div>
                    </div>
                </div>
                <!--end: Datatable -->
