...
//            ['name' => 'count_product', 'type' => 'custom', 'td' => 'CRMDV.cskh_bill.list.td.count_product', 'label' => 'Tổng SP'],
            ...
            ['name' => 'auto_extend', 'type' => 'custom', 'td' => 'CRMDV.list.td.status', 'label' => 'Tự động gia hạn', 'options' => [
                    0 => 'Không kích hoạt',
                    1 => 'Kích hoạt',
                ], 'sort' => true
            ],
            ['name' => 'status', 'type' => 'custom', 'td' => 'CRMDV.list.td.status', 'label' => 'Trạng thái', 'options' => [
                    0 => 'Không kích hoạt',
                    1 => 'Kích hoạt',
                ], 'sort' => true
            ],
...
//            ],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMDV.gh_bill.list')->with($data);
    }
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMDV.gh_bill.edit')->with($data);
            }
