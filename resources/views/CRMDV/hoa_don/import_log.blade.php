...
<head>
    <meta charset="utf-8">
    <title>Preview import hóa đơn</title>
...
<table>
    ...
    <tr class="<?php echo $r['ok'] ? 'ok' : 'error'; ?>">
        ...
        <td><?php echo $r['data']['ngay_ky'] ?? ''; ?></td>
        <td><?php echo $r['data']['ky_hieu'] ?? ''; ?></td>
        <td><?php echo $r['data']['so_hoa_don'] ?? ''; ?></td>
        <td><?php echo $r['data']['cty_name'] ?? ''; ?></td>
        <td><?php echo $r['data']['cty_mst'] ?? ''; ?></td>
        <td class="money"><?php echo number_format($r['data']['tong_tien'] ?? 0); ?></td>
...
<a href="/admin/hoa_don/import-excel">⬅ Back</a>

<form method="POST" action="/admin/hoa_don/import-commit">
