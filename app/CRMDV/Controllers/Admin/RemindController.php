...
class RemindController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'table_name' => 'reminds',
        'label' => 'Lịch nhắc nhở',
        'modal' => '\App\CRMDV\Models\Remind',
        'list' => [
            ['name' => 'name', 'type' => 'text_edit', 'label' => 'Tiêu đề', 'sort' => true],
            ['name' => 'reminded', 'type' => 'custom', 'td' => 'CRMDV.list.td.multi_care', 'label' => 'Người nhận', 'object' => 'reminded'],
            ['name' => 'hours', 'type' => 'custom', 'td' => 'CRMDV.list.td.text_remind', 'label' => 'Giờ nhận', 'sort' => true],
            ['name' => 'day_l', 'type' => 'custom', 'td' => 'CRMDV.list.td.text_remind_date', 'label' => 'Thứ trong tuần nhận', 'sort' => true],
            ['name' => 'day', 'type' => 'custom', 'td' => 'CRMDV.list.td.text_remind', 'label' => 'Ngày nhận', 'sort' => true],
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'reminded', 'type' => 'custom', 'type_history' => 'relation_multiple', 'field' => 'CRMDV.form.fields.select2_remind_model', 'multiple' => true, 'label' => 'Người nhận thông báo', 'model' => Admin::class, 'display_field' => 'name'],
...
//                    '00' => 00,
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMDV.remind.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMDV.remind.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMDV.remind.edit')->with($data);
            } else if ($_POST) {
