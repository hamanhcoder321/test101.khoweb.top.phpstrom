...
//            ['name' => 'count_product', 'type' => 'custom', 'td' => 'CRMBDS.cskh_bill.list.td.count_product', 'label' => 'Tổng SP'],
            ...
            ['name' => 'status', 'type' => 'custom', 'td' => 'CRMBDS.list.td.status', 'label' => 'Trạng thái', 'options' => [
                    0 => 'Không kích hoạt',
                    1 => 'Kích hoạt',
                ], 'sort' => true
            ],
            ...
            ['name' => 'action', 'type' => 'custom', 'td' => 'CRMBDS.cskh_bill.list.td.action', 'label' => 'Hành động'],
        ],
        'form' => [
            'general_tab' => [
            ...
            'gia_han_tab' => [
                ['name' => 'expiry_date', 'type' => 'custom', 'field' => 'CRMBDS.form.fields.expiry_date', 'label' => 'Ngày hết hạn', 'class' => 'required', 'group_class' => 'col-md-6'],
...
//            ],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMBDS.gh_bill.list')->with($data);
    }
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMBDS.gh_bill.edit')->with($data);
            }
