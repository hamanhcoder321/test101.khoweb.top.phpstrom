...
class CategoryCourseController extends \App\CRMDV\Controllers\Admin\CURDBaseController
{
    ...
    protected $module = [
        ...
        'modal' => '\App\Modules\Courses\Models\Category',
        'list' => [
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'parent_id', 'type' => 'select_model_tree', 'field' => 'CRMDV.form.fields.select_model_tree', 'class' => '', 'label' => 'Danh mục cha', 'model' => \App\Modules\Courses\Models\Category::class, 'where' => 'type in (1)', 'group_class' => 'col-md-6', 'display_field' => 'name'],
...
//        }
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('Course.Admin.category_course.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('Course.Admin.category_course.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('Course.Admin.category_course.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
