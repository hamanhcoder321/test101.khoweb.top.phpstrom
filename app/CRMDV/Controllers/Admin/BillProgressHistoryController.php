...
class BillProgressHistoryController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'label' => 'Lịch sử',
        'modal' => '\App\CRMDV\Models\BillProgressHistory',
        'list' => [
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMDV.bill_progress_history.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            if (!$_POST) {
                ...
                return view('CRMDV.bill_progress_history.add')->with($data);
            } else if ($_POST) {
//                dd($request->all());
...
//            }
        ...
        if (!$_POST) {
            ...
            return view('CRMDV.bill_progress_history.edit')->with($data);
        } else if ($_POST) {
            $validator = Validator::make($request->all(), [
                'value' => 'required'
            ], [
