...
class HRAdminController extends CURDBaseController
{
    ...
    protected $module = [
        'code' => 'hradmin',
        'label' => 'CRMBDS_admin.hradmin',
        'modal' => 'App\CRMBDS\Models\Admin',
        'table_name' => 'admin',
        'list' => [
        ...
        'form' => [
            'general_tab' => [
                ...
                /*['name' => 'role_id', 'type' => 'custom', 'field' => 'CRMBDS.hradmin.partials.select_role', 'label' => 'Quyền', 'class' => 'required', 'model' => \App\Models\Roles::class, 'display_field' => 'display_name', 'group_class' => 'col-md-6'],*/
            ...
            'more_info_tab' => [
                ['name' => 'image', 'type' => 'file_image', 'label' => 'CRMBDS_admin.hradmin_Anh'],
                ['name' => 'facebook', 'type' => 'text', 'class' => '', 'label' => 'CRMBDS_admin.hradmin_facebook'],
                ['name' => 'skype', 'type' => 'text', 'class' => '', 'label' => 'CRMBDS_admin.hradmin_skype'],
                ['name' => 'zalo', 'type' => 'text', 'class' => '', 'label' => 'CRMBDS_admin.hradmin_zalo'],
                ['name' => 'invite_by', 'type' => 'select2_ajax_model', 'label' => 'CRMBDS_admin.hradmin_recruiter', 'model' => Admin::class, 'object' => 'admin', 'display_field' => 'name', 'display_field2' => 'tel', 'class' => ''],
                ['name' => 'room_id', 'type' => 'select', 'options' => [
                    '' => '',
                    1 => 'Phòng kinh doanh 1',
                    2 => 'Phòng kinh doanh 2',
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMBDS.hradmin.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMBDS.hradmin.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMBDS.hradmin.edit')->with($data);
            } else if ($_POST) {
