...
use App\CRMBDS\Controllers\Admin\CURDBaseController;
use Validator;
...
class ReceiptPaymentController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'label' => 'CRMBDS_admin.receipt_payment',
        'modal' => '\App\CRMBDS\Models\BillReceipts',
        'list' => [
            ['name' => 'date', 'type' => 'date_vi', 'label' => 'CRMBDS_admin.receipt_payment_date'],
            ['name' => 'price', 'type' => 'price_vi', 'label' => 'CRMBDS_admin.receipt_payment_money'],
            ['name' => 'image', 'type' => 'image', 'label' => 'CRMBDS_admin.receipt_payment_Anh'],
            ['name' => 'status', 'type' => 'status', 'label' => 'CRMBDS_admin.receipt_payment_vote_review'],
        ],
        'form' => [
            'general_tab' => [
                ['name' => 'date', 'type' => 'date', 'class' => 'required', 'label' => 'CRMBDS_admin.receipt_payment_date', 'value' => '', 'group_class' => 'col-md-3'],
                ...
                ['name' => 'price', 'type' => 'price_vi', 'class' => 'required','label' => 'CRMBDS_admin.receipt_payment_transaction_amount', 'group_class' => 'col-md-4'],
                ['name' => 'image', 'type' => 'file_image', 'class' => '', 'label' => 'CRMBDS_admin.receipt_payment_proof_photo', 'group_class' => 'col-md-4'],
                ['name' => 'employees', 'type' => 'text', 'class' => '','label' => 'CRMBDS_admin.receipt_payment_Name', 'group_class' => 'col-md-4'],
                ['name' => 'note', 'type' => 'textarea', 'class' => 'required', 'label' => 'CRMBDS_admin.receipt_payment_Reason'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMBDS.receipt_payment.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            if (!$_POST) {
                ...
                return view('CRMBDS.receipt_payment.add')->with($data);
            } else if ($_POST) {
...
//                    'value.required' => 'Bắt buộc phải nhập giá trị',
    ...
    public function update(Request $request)
    {
        ...
        if (!$_POST) {
            ...
            return view('CRMBDS.receipt_payment.edit')->with($data);
        } else if ($_POST) {
            $validator = Validator::make($request->all(), [
                // 'value' => 'required'
            ], [
