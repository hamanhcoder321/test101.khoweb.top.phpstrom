                        ...
                        <div class="kt-widget kt-widget--user-profile-1">
                            ...
                            <div class="kt-widget__body">
                                <div class="kt-widget__content">
                                    ...
                                    <div class="kt-widget__info">
                                        <span class="kt-widget__label">{{trans('admin.cccd')}}:</span>
                                        <a href="#" class="kt-widget__data">{{$result->cccd}}</a>
                                    </div>
                                    <div class="kt-widget__info">
                                        <span class="kt-widget__label">{{trans('admin.gioitinh')}}:</span>
                                    ...
                                    <div class="kt-widget__head">
                                        <div class="kt-widget__media">
                                            <img style=""
                                                 src="{{ \App\Http\Helpers\CommonHelper::getUrlImageThumb(@$result->ID_card_photo_on_the_front, null, null) }}"
                                                 class="user-image user-lg-img"
                                        ...
                                        <div class="kt-widget__content">
                                            <div class="kt-widget__section">
                                                <a href="#" class="kt-widget__username">
                                                    {{trans('admin.ID_card_photo_on_the_front')}}
                                                </a>
                                                <span class="kt-widget__subtitle">
                                            {{\App\Http\Helpers\CommonHelper::getRoleName($result->id)}}
                                        </span>
                                    ...
                                    <div class="kt-widget__head">
                                        <div class="kt-widget__media">
                                            <img style=""
                                                 src="{{ \App\Http\Helpers\CommonHelper::getUrlImageThumb(@$result->ID_card_photo_on_the_back, null, null) }}"
                                                 class="user-image user-lg-img"
                                        ...
                                        <div class="kt-widget__content">
                                            <div class="kt-widget__section">
                                                <a href="#" class="kt-widget__username">
                                                    {{trans('admin.ID_card_photo_on_the_back')}}
                                                </a>
                                                <span class="kt-widget__subtitle">
                                            {{\App\Http\Helpers\CommonHelper::getRoleName($result->id)}}
                                        </span>
