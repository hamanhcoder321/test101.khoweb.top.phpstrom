...
{
    protected $whereRaw = "type is NULL";

    protected $module = [
        'code' => 'lead',
        'table_name' => 'leads',
        'label' => 'CRMBDS_admin.lead',
        'modal' => '\App\CRMBDS\Models\Lead',
        'list' => [
            ['name' => 'name', 'type' => 'custom', 'td' => 'CRMBDS.lead.list.name', 'label' => 'CRMBDS_admin.lead_name', 'sort' => true],
            ['name' => 'tel', 'type' => 'custom', 'td' => 'CRMBDS.lead.list.tel', 'label' => 'CRMBDS_admin.lead_tel', 'sort' => true],
            ['name' => 'email', 'type' => 'text', 'label' => 'Email', 'sort' => true],
            ['name' => 'source', 'type' => 'relation', 'label' => 'CRMBDS_admin.lead_source', 'object' => 'source_tag', 'display_field' => 'name', 'sort' => true],
//            ['name' => 'product', 'type' => 'text', 'label' => 'CRMBDS_admin.product', 'sort' => true],
            ...
            ['name' => 'dating', 'type' => 'custom', 'td' => 'CRMBDS.lead.list.dating', 'label' => 'CRMBDS_admin.lead_appointment', 'sort' => true],
            ['name' => 'contacted_log_last', 'type' => 'custom', 'td' => 'CRMBDS.lead.list.contacted_log_last', 'label' => 'CRMBDS_admin.lead_last-interaction', 'sort' => true],
            ['name' => 'rate', 'type' => 'tag', 'td' => 'CRMBDS.lead.list.rate', 'label' => 'CRMBDS_admin.lead_evaluate', 'sort' => true],

        ],
        'form' => [
            'general_tab' => [
                ['name' => 'name', 'type' => 'text', 'class' => 'required', 'label' => 'Tên', 'group_class' => 'col-md-3'],
                ['name' => 'tel', 'type' => 'text', 'field' => 'CRMBDS.lead.form.tel', 'class' => 'required', 'label' => 'SĐT', 'group_class' => 'col-md-3'],
                ...
                ['name' => 'rate', 'type' => 'select', 'options' => [
                    ...
                    'Quan tâm & đã xem dự án' => 'Quan tâm & đã xem dự án',
                    'Quan tâm sâu, muốn mua thực' => 'Quan tâm sâu, muốn mua thực',
                    'Đã ký HĐ' => 'Đã ký HĐ',
                    'Không có nhu cầu' => 'Không có nhu cầu',
                    'Khác (ghi rõ phần ghi chú khác)' => 'Khác (ghi rõ phần ghi chú khác)',
                ...
                ['name' => 'dating', 'type' => 'custom', 'field' => 'CRMBDS.lead.form.dating', 'class' => '', 'label' => 'Đặt hẹn ngày tương tác', 'group_class' => 'col-md-3'],
                ['name' => 'status', 'type' => 'select', 'options' => [
                    'Thả nổi' => 'Thả nổi',
                    'Đang chăm sóc' => 'Đang chăm sóc',
                    'Tạm dừng' => 'Tạm dừng',
                    'Đã ký HĐ trong dự án' => 'Đã ký HĐ trong dự án',
                    'Đã ký HĐ ngoài dự án' => 'Đã ký HĐ ngoài dự án',
            ...
            'tab_2' => [
                ['name' => 'need', 'type' => 'textarea', 'label' => 'Nhu cầu khách hàng', 'group_class' => 'col-md-12', 'inner' => 'rows=10'],
    ...
    protected $filter = [
        ...
        'marketer_ids' => [
            'label' => 'CRMBDS_admin.lead_source-marketing',
            'type' => 'select2_ajax_model',
            'display_field' => 'name',
            'display_field2' => 'code',
            'model' => \App\Models\Admin::class,
        ...
        'source' => [
            'label' => 'CRMBDS_admin.lead_source-of-customers',
            'type' => 'select2_model',
            'model' => Tag::class,
            'display_field' => 'name',
        ...
        'status' => [
            'label' => 'CRMBDS_admin.lead_status',
            'type' => 'select',
            'options' => [
                '' => 'Tất cả',
                'Đang chăm sóc' => 'Đang chăm sóc',
...
//                'Đã ký HĐ' => 'Đã ký HĐ',
        ...
        'rate' => [
            'label' => 'CRMBDS_admin.lead_evaluate',
            'type' => 'select2_model',
            'model' => Tag::class,
            'display_field' => 'name',
        ...
        'sale_status' => [
            'label' => 'CRMBDS_admin.lead_sale-status',
            'type' => 'select',
            'options' => [
                '' => 'Tất cả',
        ...
        'lead_status' => [
            'label' => 'CRMBDS_admin.lead_arrange',
            'type' => 'select',
            'options' => [
                '' => 'Không',
...
//                     $query->orWhere('admin_id', \Auth::guard('admin')->user()->id);
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMBDS.lead.list')->with($data);
    }
    ...
    public function add_test(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMBDS.lead.add_test')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
    ...
    public function checkExist(Request $request) {
        ...
        if ($request->has('tel')) {
            ...
            $customer = \App\CRMBDS\Models\Admin::select('id', 'email', 'name', 'tel', 'created_at', 'sale_id')->where('tel', $request->tel)->first();
