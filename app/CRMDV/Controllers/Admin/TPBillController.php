...
//            ['name' => 'count_product', 'type' => 'custom', 'td' => 'CRMDV.tpbill.list.td.count_product', 'label' => 'Tổng SP'],
...
//                    'label' => 'Khách hàng', 'model' => \App\Models\User::class, 'object' => 'name', 'display_field' => 'name', 'display_field2' => 'tel','class' => 'required'],
                ['name' => 'customer_id', 'type' => 'custom', 'type_history' => 'relation_multiple', 'field' => 'CRMDV.form.fields.select_customer',
                    'label' => 'Khách hàng', 'model' => \App\Models\User::class, 'object' => 'user', 'display_field' => 'name', 'display_field2' => 'tel', 'class' => 'required'],
            ...
            'gia_han_tab' => [
                ['name' => 'expiry_date', 'type' => 'custom', 'field' => 'CRMDV.form.fields.expiry_date', 'label' => 'Ngày hết hạn', 'class' => 'required', 'group_class' => 'col-md-6'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMDV.tpbill.list')->with($data);
    }
    ...
    public function appendWhere($query, $request)
    {
        ...
        if (CommonHelper::has_permission(\Auth::guard('admin')->user()->id, 'bill_view_all')) {
            ...
            $query = $query->where(function ($query) use ($request, $members) {
                $query = $query->orWhereIn('saler_id', $members); //  truy vấn đơn hàng của thành viên phòng mình
                $query->orWhere('staff_care', 'like', '%|' . \Auth::guard('admin')->user()->id . '|%'); //  hợp đồng mình theo dõi
            });
        }
    ...
    public function add(Request $request)
    {
        try {
            if (!$_POST) {
                ...
                return view('CRMDV.tpbill.add')->with($data);
            }
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMDV.tpbill.edit')->with($data);
            }
