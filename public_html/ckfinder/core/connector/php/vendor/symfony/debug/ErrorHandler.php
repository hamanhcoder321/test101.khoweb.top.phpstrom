 ...
 *
 * Provides five bit td that control how errors are handled:
...
class ErrorHandler
{
    ...
    private $levels = array(
        ...
        E_USER_DEPRECATED => 'BillPayment Deprecated',
        E_NOTICE => 'Notice',
        E_USER_NOTICE => 'BillPayment Notice',
        E_STRICT => 'Runtime Notice',
        E_WARNING => 'Warning',
        E_USER_WARNING => 'BillPayment Warning',
        E_COMPILE_WARNING => 'Compile Warning',
        E_CORE_WARNING => 'Core Warning',
        E_USER_ERROR => 'BillPayment Error',
    ...
    /**
     * Handles errors by filtering then logging them according to the configured bit td.
     *
