...
class ServiceController extends CURDBaseController
{
    ...
    protected $module = [
        'code' => 'service',
        'table_name' => 'services',
        'label' => 'CRMEdu_admin.services',
        'modal' => '\App\CRMEdu\Models\Service',
        'list' => [
            ['name' => 'name_vi', 'type' => 'text_edit', 'label' => 'CRMEdu_admin.services_name', 'sort' => true],
//            ['name' => 'expiry_date', 'type' => 'date_vi', 'label' => 'Hết hạn'],
//            ['name' => 'intro', 'type' => 'text', 'label' => 'Mô tả', 'sort' => true],
        ],
        'form' => [
            'general_tab' => [
                ['name' => 'name_vi', 'type' => 'text', 'class' => 'required', 'label' => 'CRMEdu_admin.services_Ten'],
//                ['name' => 'code', 'type' => 'text', 'class' => 'required', 'label' => 'Mã',],
//                ['name' => 'expiry_date', 'type' => 'number', 'label' => 'Hết hạn'],
                ['name' => 'intro', 'type' => 'textarea', 'label' => 'CRMEdu_admin.services_Mo_ta'],
...
//                ]],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMEdu.service.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMEdu.service.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMEdu.service.edit')->with($data);
            } else if ($_POST) {
...
//            CommonHelper::one_time_message('error', $ex->getMessage());
    ...
    public function show()
    {
        ...
        $data['page_type'] = 'list';
        return view('CRMEdu.service.show')->with($data);
    }
