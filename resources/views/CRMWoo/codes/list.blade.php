...
@section('main')
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <a href="https://youtu.be/nl33Q5z3xaA" target="_blank">Hướng dẫn cập nhật thông tin & kich hoạt mẫu giao diện các {{ trans('CRMWoo_admin.hop_dong') }} đã làm vào kho giao diện</a>
