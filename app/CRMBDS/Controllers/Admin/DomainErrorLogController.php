...
class DomainErrorLogController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'label' => 'Website lỗi',
        'modal' => '\App\CRMBDS\Models\CheckErrorLinkLogs',
        'list' => [
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMBDS.check_error_link_logs.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMBDS.check_error_link_logs.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMBDS.check_error_link_logs.edit')->with($data);
            } else if ($_POST) {
