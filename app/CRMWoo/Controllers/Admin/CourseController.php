...
class CourseController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'modal' => '\App\CRMWoo\Models\Course',
        'list' => [
            ...
            ['name' => 'level', 'type' => 'text', 'label' => 'CRMWoo_admin.level_course', 'sort' => true],
            ['name' => 'status', 'type' => 'status', 'label' => 'Trang thái', 'url' => '/admin/course/publish'],
        ],
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'link', 'type' => 'text', 'label' => 'Đường link', 'group_class' => 'col-md-12'],
                ...
                ['name' => 'level', 'type' => 'text', 'class' => '', 'label' => 'CRMWoo_admin.level_course', 'group_class' => 'col-md-6'],
    ...
    public function view(Request $request, $id)
    {
        ...
        return view('CRMWoo.course.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMWoo.course.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMWoo.course.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
