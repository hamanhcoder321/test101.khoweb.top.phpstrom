...
@section('main')
    @php
        ...
        $url_back = '/admin/' . $module['code'];

        if (isset($result->partner) && strpos($result->partner, '|'.\Auth::guard('admin')->user()->id.'|') !== false) {
            $url_back = '/admin/lead/doi-tac';
        }

        if(isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'], $module['code'] . '/edit') === false) {
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile"
                    ...
                    <div class="kt-portlet__head kt-portlet__head--lg" style="">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            ...
                            <a href="{{ $url_back }}" class="btn btn-clean kt-margin-r-10">
