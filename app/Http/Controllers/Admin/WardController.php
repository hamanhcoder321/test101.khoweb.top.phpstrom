...
class WardController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'province_id', 'type' => 'select2_model', 'class' => 'required', 'label' => 'Tỉnh/Thành', 'model' => \App\Models\Province::class, 'display_field' => 'name',],
                ['name' => 'district_id', 'type' => 'select2_model', 'class' => 'required', 'label' => 'Quận/Huyện', 'model' => \App\Models\District::class, 'display_field' => 'name',],
            ],
        ],
