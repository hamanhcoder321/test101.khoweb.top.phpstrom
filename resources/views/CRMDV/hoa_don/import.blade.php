...
@section('main')
    @if ($errors->has('excel'))
        <div class="alert alert-warning">
            <strong>⚠️ File Excel chưa đúng định dạng</strong><br>
            {{ $errors->first('excel') }}
            <hr>
            <small>
                👉 Mở file bằng <b>Microsoft Excel</b><br>
                👉 Chọn <b>File → Save As → Excel Workbook (*.xlsx)</b><br>
                👉 Upload lại file vừa lưu
            </small>
        </div>
    @endif
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile"
                    ...
                    <div class="kt-portlet__head kt-portlet__head--lg" style="">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">{{trans('admin.add')}} Hóa đơn
                            </h3>
                        </div>
                        <div class="kt-portlet__head-toolbar">
                            <a href="/admin/hoa_don" class="btn btn-clean kt-margin-r-10">
...
{{--                                    </div>                                                                            </div>--}}
                                <div class="form-group-div form-group " id="form-group-btn_download_excel_demo">
                                    ...
                                    <div class="col-xs-12">
                                        <a href="{{ url('filemanager/userfiles/excel_default/check_trung.xlsx') }}"
