...
class MKTLeadController extends CURDBaseController
{
    ...
    protected $module = [
        'code' => 'lead',
        'table_name' => 'leads',
        'label' => 'CRMBDS_admin.leads',
        'modal' => '\App\CRMBDS\Models\Lead',
        'list' => [
            ['name' => 'id', 'type' => 'text', 'label' => 'CRMBDS_admin.leads_ID', 'sort' => true],
            ['name' => 'name', 'type' => 'custom', 'td' => 'CRMBDS.lead.list.name', 'label' => 'Tên', 'sort' => true],
            ['name' => 'product', 'type' => 'text', 'label' => 'CRMBDS_admin.leads_Linh_vuc_KD', 'sort' => true],
            ['name' => 'tinh', 'type' => 'text', 'label' => 'CRMBDS_admin.leads_Tinh', 'sort' => true],
            ['name' => 'tel', 'type' => 'custom', 'td' => 'CRMBDS.lead.list.tel', 'label' => 'SĐT', 'sort' => true],
            ['name' => 'created_at', 'type' => 'date_vi', 'label' => 'CRMBDS_admin.leads_NT', 'sort' => true],
            ['name' => 'rate', 'type' => 'custom', 'td' => 'CRMBDS.lead.list.rate', 'label' => 'Đánh giá', 'sort' => true],
            ['name' => 'contacted_log_last', 'type' => 'custom', 'td' => 'CRMBDS.lead.list.contacted_log_last', 'label' => 'TT lần cuối', 'sort' => true],
            ['name' => 'admin_id', 'type' => 'relation', 'label' => 'CRMBDS_admin.leads_Ng_tao', 'object' => 'admin', 'display_field' => 'name'],
        ],
        'form' => [
            'general_tab' => [
    ...
    protected $filter = [
        ...
        'marketer_ids' => [
            'label' => 'CRMBDS_admin.leads_marketing',
            'type' => 'select2_ajax_model',
            'display_field' => 'name',
            'display_field2' => 'code',
            'model' => \App\Models\Admin::class,
        ...
        'source' => [
            'label' => 'CRMBDS_admin.leads_Ng_kh',
            'type' => 'text',
            'query_type' => 'like'
        ],
        'tinh' => [
            'label' => 'CRMBDS_admin.leads_T',
            'type' => 'text',
            'query_type' => 'like'
        ],
        'service' => [
            'label' => 'CRMBDS_admin.leads_DV',
            'type' => 'select',
            'options' => [
                '' => 'Tất cả',
        ...
        'status' => [
            'label' => 'CRMBDS_admin.leads_status',
            'type' => 'select',
            'options' => [
                '' => 'Tất cả',
        ...
        'sale_status' => [
            'label' => 'CRMBDS_admin.leads_sale_status',
            'type' => 'select',
            'options' => [
                '' => 'Tất cả',
        ...
        'lead_status' => [
            'label' => 'CRMBDS_admin.leads_lead_status',
            'type' => 'select',
            'options' => [
                '' => 'Không',
        ...
        'contacted_log_last' => [
            'label' => 'CRMBDS_admin.leads_contacted_log_last',
            'type' => 'from_to_date',
            'query_type' => 'from_to_date'
        ],
        'check_tel' => [
            'label' => 'CRMBDS_admin.leads_Check_tel',
            'type' => 'textarea',
            'query_type' => 'custom'
        ],
    ];
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMBDS.mktlead.list')->with($data);
    }
