...
//            ['name' => 'count_product', 'type' => 'custom', 'td' => 'CRMEdu.cskh_bill.list.td.count_product', 'label' => 'Tổng SP'],
            ...
            ['name' => 'status', 'type' => 'custom', 'td' => 'CRMEdu.list.td.status', 'label' => 'Trạng thái', 'options' => [
                    0 => 'Không kích hoạt',
                    1 => 'Kích hoạt',
                ], 'sort' => true
            ],
            ...
            ['name' => 'action', 'type' => 'custom', 'td' => 'CRMEdu.cskh_bill.list.td.action', 'label' => 'Hành động'],
        ],
        'form' => [
            'general_tab' => [
...
//            ],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMEdu.gh_bill.list')->with($data);
    }
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMEdu.gh_bill.edit')->with($data);
            }
