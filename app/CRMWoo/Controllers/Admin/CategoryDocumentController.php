...
class CategoryDocumentController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'parent_id', 'type' => 'custom', 'field' => 'CRMWoo.form.fields.select_model_tree', 'class' => '', 'label' => 'Danh mục cha', 'model' => \App\CRMWoo\Models\Category::class, 'where' => 'type in (5)', 'group_class' => 'col-md-6', 'display_field' => 'name'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMWoo.category_document.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMWoo.category_document.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMWoo.category_document.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
