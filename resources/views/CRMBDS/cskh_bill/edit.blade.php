...
@section('main')
    ...
    <form class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid {{ @$module['code'] }}"
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-4">
                @include('CRMBDS.form.fields.history_extension')
                ...
                @include('CRMBDS.bill.partials.dich_vu_lien_quan', ['customer_id' => $result->customer_id, 'bill_id' => $result->id])
            </div>
        </div>
            ...
            <div class="kt-portlet">
                ...
                <div class="kt-form">
                    <div class="kt-portlet__body">
                        ...
                        <div class="log_logs">
                            <?php
                            $logs = \App\CRMBDS\Models\LeadContactedLog::where('type', 'hđ')->where('lead_id', @$result->id)->orderBy('id', 'desc')->get();
                            ?>
                            @foreach($logs as $log)
                                <hr>
