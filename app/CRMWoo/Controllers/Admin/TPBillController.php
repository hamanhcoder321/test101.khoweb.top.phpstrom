...
//            ['name' => 'count_product', 'type' => 'custom', 'td' => 'CRMWoo.tpbill.list.td.count_product', 'label' => 'Tổng SP'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMWoo.tpbill.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            if (!$_POST) {
                ...
                return view('CRMWoo.tpbill.add')->with($data);
            }
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMWoo.tpbill.edit')->with($data);
            }
