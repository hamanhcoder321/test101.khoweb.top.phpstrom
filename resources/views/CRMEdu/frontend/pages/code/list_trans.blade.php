...
<div class="kho-code theme-container">
    <div class="kho-code-form">
        <form method="GET" action="" id="form-search">
            ...
            <div class="col-md-3">
                <?php
                $cats = \App\CRMEdu\Models\Category::select('id', 'name')->where('type', 10)->where('status', 1)->orderBy('name', 'asc')->get();
                ?>
            ...
            <div class="col-md-3">
                <?php
                $tag_ids = \App\CRMEdu\Models\PostTag::where('multi_cat', 'like', '%|'.@$_GET['cat_id'].'|%')->groupBy('tag_id')->pluck('tag_id')->toArray();
                $tags = \App\CRMEdu\Models\Tag::whereIn('id', $tag_ids)->orderBy('name', 'asc')->get();
                ?>
