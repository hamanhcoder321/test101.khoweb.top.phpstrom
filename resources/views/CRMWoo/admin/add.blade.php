                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                ...
                                @if(in_array('role_view', $permissions))
                                        <?php
                                        $field = ['name' => 'role_id', 'type' => 'custom', 'field' => 'CRMWoo.admin.partials.select_role', 'label' => 'Quyền', 'class' => 'required', 'model' => \App\Models\Roles::class, 'display_field' => 'display_name'];
                                        ?>

                                    @if($field['type'] == 'custom')
                                        @include('CRMWoo.admin.partials.select_role', ['field' => $field])
                                    @else
                                        <div class="form-group-div form-group {{ @$field['group_class'] }}"
                                             id="form-group-{{ $field['name'] }}">
                                            <label for="{{ $field['name'] }}">{{ trans(@$field['label']) }} @if(strpos(@$field['class'], 'require') !== false)
