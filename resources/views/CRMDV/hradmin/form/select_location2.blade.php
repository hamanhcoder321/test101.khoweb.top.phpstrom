@if(@$field['province'] !== false)
    @php
        ...
        'object' => 'province', 'display_field' => 'name', 'group_class' => 'col-md-3'];
...
@if(@$field['district'] !== false)
    @php
        ...
        'object' => 'district', 'display_field' => 'name', 'group_class' => 'col-md-3'];
        $fd['value'] = @$result->{$fd['name']};
    @endphp
    <div class="col-xs-4">
        <div class="form-group-div form-group {{ @$fd['group_class'] }}"
...
@if(@$field['ward'] !== false)
    @php
        ...
        'object' => 'ward', 'display_field' => 'name', 'group_class' => 'col-md-3'];
        $fd['value'] = @$result->{$fd['name']};
    @endphp
    <div class="col-xs-4">
        <div class="form-group-div form-group {{ @$fd['group_class'] }}"
