...
class UserController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'email', 'type' => 'custom', 'field' => 'CRMEdu.admin.form.email', 'class' => '', 'label' => 'admin.email', 'group_class' => 'col-md-4'],
                ['name' => 'tel', 'type' => 'custom', 'class' => 'required', 'field' => 'CRMEdu.admin.form.tel', 'label' => 'admin.phone', 'group_class' => 'col-md-4'],
                ['name' => 'code', 'type' => 'text', 'class' => '', 'field' => 'CRMEdu.admin.form.tel', 'label' => 'Mã', 'group_class' => 'col-md-4'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMEdu.user.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMEdu.user.add')->with($data);
            } else if ($_POST) {
