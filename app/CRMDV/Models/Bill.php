...
class Bill extends Model
{
    ...
    protected $fillable = [
        ...
        'total_price_contract','price_month','price_period','total_received','dich_vu_ban_tiep','account_note','link_hd','hd_luu_tru','bbtl_luu_tru'
    ];
    ...
    {
        return $this->belongsTo(Admin::class, 'customer_legal_id', 'id');
    }
    ...
    public function bill_progress_history()
    {
        return $this->hasMany(BillProgressHistory::class, 'bill_id', 'id');
    }
}
