...
class GuideController extends CURDBaseController
{
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CoreERP.guide.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CoreERP.guide.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CoreERP.guide.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
