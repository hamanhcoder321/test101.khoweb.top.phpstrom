...
@section('main')
    ...
    <div class="col-xs-12 menu-document">
        <ul class="nav">
            ...
            <?php
                $categories = \App\CRMBDS\Models\Category::select('id', 'name')->where('status', 1)->where('type', 1);
            ...
            @foreach($categories as $cat)
                <?php
                    $cat_childs = \App\CRMBDS\Models\Category::select('id', 'name')->where('status', 1)->where('type', 1)
            ...
            <li class="nav-item">
                ...
                <ul class="dropdown-menu">
                    @foreach($cat_childs as $cat_child)
                        <?php
                            $cat3_childs = \App\CRMBDS\Models\Category::select('id', 'name')->where('status', 1)->where('type', 1)
