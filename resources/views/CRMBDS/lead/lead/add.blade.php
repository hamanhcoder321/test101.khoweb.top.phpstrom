                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                ...
                                @if(\Auth::guard('admin')->user()->super_admin == 1)
                                    ...
                                    <?php
                                    $field = ['name' => 'marketer_ids', 'type' => 'select2_ajax_model', 'label' => 'Người giới thiệu', 'model' => \App\Models\Admin::class, 'object' => 'admin', 'display_field' => 'name', 'multiple' => true, 'group_class' => 'col-md-12'];
                                    ?>
                                    <div class="form-group-div form-group {{ @$field['group_class'] }}"
                                             id="form-group-{{ $field['name'] }}">
                                            <label for="{{ $field['name'] }}">{{ @$field['label'] }} @if(strpos(@$field['class'], 'require') !== false)
