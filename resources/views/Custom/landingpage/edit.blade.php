                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile"
                    ...
                    <div class="kt-portlet__head kt-portlet__head--lg" style="">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            ...
                            <div class="btn-group">
                                @if(in_array('landingpage_edit', $permissions))
            ...
            <div class="col-xs-12 col-md-4">
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-form">
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                @if(isset($result->bill->handover_landingpage) && $result->bill->handover_landingpage != 0)
                                    <span class="alert alert-success">Đã bàn giao {{ $result->bill->handover_landingpage }} lần</span>
                                @else
                                    <span class="alert alert-danger">Chưa bàn giao</span>
                                @endif
                                <a class="btn btn btn-primary btn-add-dynamic" href="/admin/{{ $module['code'] }}/{{ $result->id }}/ban-giao"
