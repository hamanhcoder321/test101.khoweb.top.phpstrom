...
<head>
    ...
    <title>Cổng hỗ trợ @if(!isset($_GET['hb'])) - HBWEB @endif</title>
    ...
    @if(!isset($_GET['hb']))
        ...
        <meta property="og:title" content="Cổng hỗ trợ" />
        ...
        <meta name="twitter:title" content="Cổng hỗ trợ" />
...
@if(!isset($_GET['hb']))
    ...
    top: auto;">
            ...
            <div class="template_id">
                <a target="_blank">Liên hệ hotline mua web: 0877783626</a>
            </div>
...
<div id="iframelive" style="height: 750px;">
    ...
    z-index: 999999999999;"></div>
            @endif
                ...
                <iframe src="https://khoweb.top/pavietnam-ticket.php" style="background: #fff;" width="100%" height="600"></iframe>
        </div>
    </div>
</div>
