...
class CategoryCourseController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'modal' => '\App\CRMBDS\Models\Category',
        'list' => [
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'parent_id', 'type' => 'select_model_tree', 'field' => 'CRMBDS.form.fields.select_model_tree', 'class' => '', 'label' => 'Danh mục cha', 'model' => \App\CRMBDS\Models\Category::class, 'where' => 'type in (1)', 'group_class' => 'col-md-6', 'display_field' => 'name'],
                ['name' => 'order_no', 'type' => 'number', 'class' => '', 'label' => 'Thứ tự', 'des' => 'Số to hiển thị trước', 'group_class' => 'col-md-4'],
                ['name' => 'role_ids', 'type' => 'select2_ajax_model', 'label' => 'Nhóm quyền được xem', 'model' => Roles::class, 'object' => 'role', 'display_field' => 'display_name', 'multiple' => true, 'group_class' => 'col-md-8'],
...
//        }
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMBDS.category_course.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMBDS.category_course.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMBDS.category_course.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
