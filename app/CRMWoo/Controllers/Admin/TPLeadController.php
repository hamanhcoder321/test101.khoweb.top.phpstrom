...
class TPLeadController extends CURDBaseController
{
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'service', 'type' => 'select2', 'options' => [
                    ...
                    'design khác' => 'design khác',
                    'game' => 'game',
                ], 'label' => 'Sản phẩm', 'multiple' => true, 'group_class' => 'col-md-3'],
                ...
                ['name' => 'product', 'type' => 'text', 'label' => 'Sản phẩm/Sản phẩm của khách', 'group_class' => 'col-md-3'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMWoo.tplead.list')->with($data);
    }
