...
use Modules\CheckErrorLink\Models\LinkErrorLogs;
    ...
    public static function check_link_run($linkchecks)
    {
        try {
            ...
            foreach ($linkchecks as $url) {
                ...
                $ch = curl_init();
                curl_setopt($ch, CURLOPT_URL, $url->links);
                ...
                if ($code == 0) {
                    ...
                    $list[] = CommonHelper::logs_error_link($code, $url);
                } elseif ($code != 200) {
                    $http_code = [
            ...
            CommonHelper::send_mail_notifications($list);
            return [
                'status' => true
            ];
        } catch (Exception $ex) {
