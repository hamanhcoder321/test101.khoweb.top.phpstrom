...
use App\CRMWoo\Models\Category;
...
class DocumentController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'label' => 'Tài liệu',
        'modal' => '\App\CRMWoo\Models\Document',
        'list' => [
            ['name' => 'name', 'type' => 'text_edit', 'label' => 'Tiêu đề', 'sort' => true],
            ['name' => 'service_id', 'type' => 'relation', 'label' => 'CRMWoo_admin.tai_lieu_cho_dich_vu', 'object' => 'service', 'display_field' => 'name_vi', 'sort' => true],
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'multi_cat', 'type' => 'custom', 'field' => 'CRMWoo.form.fields.multi_cat', 'label' => 'Danh mục', 'model' => Category::class,
                    'object' => 'category_document', 'where' => 'type in (5)', 'display_field' => 'name', 'multiple' => true, 'group_class' => 'col-md-6'],
                ['name' => 'service_id', 'type' => 'select2_model', 'class' => ' ',  'label' => 'CRMWoo_admin.tai_lieu_cho_dich_vu', 'model' => Service::class, 'display_field' => 'name_vi', 'group_class' => 'col-md-3'],
    ...
    protected $filter = [
        ...
        'service_id' => [
            ...
            'model' => \App\CRMWoo\Models\Service::class,
            'object' => 'service',
            'query_type' => '='
        ],
        'created_at' => [
    ...
    public function view(Request $request, $id)
    {
        ...
        return view('CRMWoo.document.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMWoo.document.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMWoo.document.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
