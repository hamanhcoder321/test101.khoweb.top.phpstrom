    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            <h3 class="kt-portlet__head-title">
                {{ trans('CRMDV_admin.hop_dong_da_ky') }}
            </h3>
        </div>
    </div>
    <!--begin::Form-->
    <div class="kt-form">
        <div class="kt-portlet__body">
            <div class="kt-section kt-section--first">
                <?php 
                $bill_relate = \App\Modules\HBBill\Models\Bill::select('id', 'domain', 'service_id', 'registration_date', 'total_price_contract')
                    ->where('customer_id', $customer_id)->where('id', '!=', @$bill_id)->orderBy('registration_date', 'desc')->get();
                ?>
