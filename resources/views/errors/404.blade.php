...
<div class="m-grid m-grid--hor m-grid--root m-page"
     style="height:100%;background-image: url({{asset('public/error/bg1.jpg')}})">
    <div class="m-grid__item m-grid__item--fluid m-grid  m-error-1">
        <div class="m-error_container">
            ...
            <button class="btn btn-outline-success" style="margin-left: 6%" onclick="window.history.back();">Quay lại
            </button>
        </div>
    </div>
</div>
