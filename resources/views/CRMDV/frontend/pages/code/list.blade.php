...
<div class="kho-code theme-container">
    <div class="kho-code-form">
        <form method="GET" action="" id="form-search">
            ...
            @if(isset($_GET['hb']))
            <input type="hidden" name="hb" value="true">
            @endif
                        ...
                        <div class="theme-links" style="top: 70%;">
                            ...
                            @else
                                ...
                                @else
                                    ...
                                    @else
                                        <a rel="nofollow" target="_blank" class="demo"
                                           href="/mau-web/{{$item->id}}{{ isset($_GET['hb']) ? '?hb=1' : '' }}">Xem demo
                                        </a>
                                    @endif
    ...
    <div class="generality-page">
        <div class="kt-datatable__pager kt-datatable--paging-loaded"
            ...
            {!! $listItem->appends(isset($param_url) ? $param_url : '')->appends(isset($_GET['hb']) ? $_GET['hb'] : '')->links() != '' ? $listItem->appends(isset($param_url) ? $param_url : '')->appends(isset($_GET['hb']) ? $_GET['hb'] : '')->links() : '<ul class="pagination page-numbers nav-pagination links text-center"></ul>' !!}
