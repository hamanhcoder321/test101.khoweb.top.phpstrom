...
use App\CRMWoo\Models\Timekeeper;
use Validator;
...
class TimekeeperController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'modal' => '\App\CRMWoo\Models\Timekeeper',
        'list' => [
            ...
            ['name' => 'thoi_gian_muon', 'type' => 'custom', 'td' => 'CRMWoo.timekeeper.list.td.thoi_gian_muon', 'label' => 'Thời gian muộn'],
            ['name' => 'status', 'type' => 'custom', 'td' => 'CRMWoo.timekeeper.list.td.ly_do_muon', 'label' => 'Lý do muộn'],
        ],
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'time', 'type' => 'datetime-local', 'class' => '', 'label' => 'Thời gian chấm công bvc', 'group_class' => 'col-md-6'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMWoo.timekeeper.list')->with($data);
    }
    ...
    public function baoCao(Request $request) {
        ...
        return view('CRMWoo.timekeeper.bao_cao')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMWoo.timekeeper.add')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMWoo.timekeeper.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
...
//            CommonHelper::one_time_message('error', 'Lỗi hệ thống! Vui lòng liên hệ kỹ thuật viên.');
    ...
    public function processingImport($r, $item)
    {
        ...
        Timekeeper::where('time', '<', date('Y-m-d', strtotime(" -7 days")))->delete();
