...
//            ['name' => 'expiry_date', 'type' => 'date_vi', 'label' => 'Hết hạn'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMDV.plan.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMDV.plan.add')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMDV.plan.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
