                            ...
                            <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                ...
                                @if(in_array('receipts_publish', $permissions))
                                    ...
                                    <td>
                                        ...
                                        @endif
                                            <br>
                                            <span style="@if($item->so_hoa_don === NULL && in_array($item->receiving_account, [61, 68]))color: red; font-weight: bold;@endif">Số Hoá đơn: {{ $item->so_hoa_don }}</span>
                                    </td>


                                    <td>
                                        Nội dung: <strong>{{ $item->note }}</strong><br>
                                        TK: <strong>{{ @$item->receivingAccount->name }}</strong><br>
