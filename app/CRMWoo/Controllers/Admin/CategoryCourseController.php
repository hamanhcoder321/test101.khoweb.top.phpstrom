...
class CategoryCourseController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'modal' => '\App\CRMWoo\Models\Category',
        'list' => [
        ...
        'form' => [
            'general_tab' => [
                ...
                ['name' => 'parent_id', 'type' => 'select_model_tree', 'field' => 'CRMWoo.form.fields.select_model_tree', 'class' => '', 'label' => 'Danh mục cha', 'model' => \App\CRMWoo\Models\Category::class, 'where' => 'type in (1)', 'group_class' => 'col-md-6', 'display_field' => 'name'],
...
//        }
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMWoo.category_course.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMWoo.category_course.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMWoo.category_course.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
