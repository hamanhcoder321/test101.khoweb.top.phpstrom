    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="col-sm-6">
                ...
                <?php 
                $total_time = \App\CRMBDS\Models\Timekeeping::where('status', 0);
                if ($admin_id != null) {
                ...
                <?php 
                $last_timekeeping = \App\CRMBDS\Models\Timekeeping::select('day')->where('status', 0);
                if ($admin_id != null) {
                    $last_timekeeping = $last_timekeeping->where('admin_id', $admin_id);
                }
                $last_timekeeping = $last_timekeeping->orderBy('day', 'asc')->first();
                $khqt = \App\CRMBDS\Models\Lead::whereIn('status', ['Đang chăm sóc']);
                if ($admin_id != null) {
