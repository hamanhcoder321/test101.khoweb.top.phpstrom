...
class BillHistoryController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'list' => [
            ...
            ['name' => 'service_id', 'type' => 'relation', 'label' => 'Sản phẩm', 'object' => 'service', 'display_field' => 'name_vi', 'sort' => true],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMWoo.bill_history.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            if (!$_POST) {
                ...
                return view('CRMWoo.bill_history.add')->with($data);
            } else if ($_POST) {
//                dd($request->all());
...
//                    'value.required' => 'Bắt buộc phải nhập giá trị',
                ...
                if ($validator->fails()) {
                    ...
                    $data['status'] = 1;
                    $data['service_id'] = 7;    //  mặc định chọn Sản phẩm gia hạn
...
//            }
        ...
        if (!$_POST) {
            ...
            return view('CRMWoo.bill_history.edit')->with($data);
        } else if ($_POST) {
            $validator = Validator::make($request->all(), [
                'value' => 'required'
            ], [
...
//        }
    ...
    public function ajaxLichSuTrangThai(Request $request) {
        ...
        return view("CRMWoo.dhbill.partials.lich_su_trang_thai_view")->with($data);
    }
}
