...
?>
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="lead-chart">
            ...
            <span>Điểm {{ trans('CRMBDS_admin.ky_thuat') }}: 0</span>&nbsp;&nbsp;&nbsp;&nbsp;
            <span>Điểm {{ trans('CRMBDS_admin.dieu_hanh') }}: 0</span>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--scroll kt-datatable--loaded"
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($listItem as $k => $item)
                            ...
                            @if(in_array(@$item->bill_progress->status, ['Bỏ', 'Tạm dừng', 'Kết thúc']))
                                ket-thuc
                            @elseif(in_array(@$item->bill_progress->status, ['Khách xác nhận xong']))
                                khach-xac-nhan-xong
                            @endif
                            " style="left: 0px;">
    ...
    @include('CRMBDS.dhbill.partials.change_status_bill_process')
@endsection
