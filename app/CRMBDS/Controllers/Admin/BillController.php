...
//    protected $whereRaw = 'service_id IN (1, 17, 18, 19, 20, 21)';
    ...
    protected $module = [
        'code' => 'bill',
        'table_name' => 'bills',
        'label' => 'CRMBDS_admin.bills',
        'modal' => '\App\CRMBDS\Models\Bill',
        'list' => [
//            ['name' => 'domain', 'type' => 'text_edit', 'label' => 'Tên miền', 'sort' => true],
            ['name' => 'customer_id', 'type' => 'relation_edit', 'label' => 'CRMBDS_admin.bills_client', 'object' => 'customer', 'display_field' => 'name'],
            ['name' => 'total_price', 'type' => 'price_vi', 'label' => 'CRMBDS_admin.bills_total_price', 'sort' => true],
            ['name' => 'total_price_contract', 'type' => 'price_vi', 'label' => 'CRMBDS_admin.bills_total_money'],
            ['name' => 'total_received', 'type' => 'price_vi', 'label' => 'CRMBDS_admin.bills_money_received'],
            ['name' => 'finance_id', 'type' => 'custom', 'td' => 'CRMBDS.dhbill.list.td.chua_thu', 'label' => 'CRMBDS_admin.bills_uncollected_money'],
            ['name' => 'service_id', 'type' => 'relation', 'label' => 'CRMBDS_admin.service', 'object' => 'service', 'display_field' => 'name_vi', 'sort' => true],
//            ['name' => 'count_product', 'type' => 'custom', 'td' => 'CRMBDS.list.td.count_product', 'label' => 'Tổng SP'],
            ['name' => 'registration_date', 'type' => 'date_vi', 'label' => 'CRMBDS_admin.bills_contract_signing_date', 'sort' => true],
...
//            ['name' => 'auto_extend', 'type' => 'custom', 'td' => 'CRMBDS.list.td.status', 'label' => 'Tự động gia hạn', 'options' => [
//                    0 => 'Không kích hoạt',
//                    1 => 'Kích hoạt',
//                ], 'sort' => true
//            ],
            ['name' => 'status', 'type' => 'custom', 'td' => 'CRMBDS.list.td.status', 'label' => 'CRMBDS_admin.bills_status', 'options' => [
                    0 => 'Không kích hoạt',
                    1 => 'Kích hoạt',
                ], 'sort' => true
            ],
//            ['name' => 'dating', 'type' => 'date_vi', 'label' => 'CRMBDS_admin.bills_dating', 'sort' => true],
        ],
        'form' => [
            'general_tab' => [
...
//                ['name' => 'domain', 'type' => 'text', 'label' => 'Tên miền', 'group_class' => 'col-md-4'],
            ...
            'customer_tab' => [
                ...
                ['name' => 'customer_id', 'type' => 'custom', 'type_history' => 'relation_multiple', 'field' => 'CRMDV.form.fields.select_customer',
                    'label' => 'CRMBDS_admin.bill_client', 'model' => User::class, 'object' => 'user', 'display_field' => 'name', 'display_field2' => 'tel', 'class' => 'required'],
                ['name' => 'customer_legal_id', 'type' => 'custom', 'type_history' => 'relation_multiple', 'field' => 'CRMDV.form.fields.select_customer',
                    'label' => 'CRMBDS_admin.bill_legal', 'model' => User::class, 'object' => 'user', 'display_field' => 'name', 'display_field2' => 'tel', 'class' => ''],
            ],
            'gia_han_tab' => [
...
//                ['name' => 'customer_note', 'type' => 'textarea', 'class' => 'required', 'label' => 'Ghi chú của Khách'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMBDS.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        ...
        try {
            if (!$_POST) {
                ...
                return view('CRMBDS.add')->with($data);
            }
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMBDS.edit')->with($data);
            }
