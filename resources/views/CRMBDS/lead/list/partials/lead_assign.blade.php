        ...
        <div class="modal-content" style="width:100%;height:100%">
            ...
            <div class="modal-body">
                <form class="kt-form kt-form--fit kt-margin-b-20" action="/admin/lead/assign" method="POST">
                    ...
                    <div class="form-group-div form-group">
                        <?php
                            $options = \App\CRMBDS\Models\Tag::where('type', 'lead_rate')->orderBy('order_no', 'desc')->pluck('name', 'id')->toArray();
                            $options['-'] = 'Không sửa đánh giá';
                            $options[''] = 'Chưa đánh giá';

                        $field = ['name' => 'rate', 'type' => 'select', 'options' => $options, 'label' => 'Đánh giá', 'value' => '-'];
                        ?>
                        @include(config('core.admin_theme').".form.fields.".$field['type'], ['field' => $field])
                    </div>
