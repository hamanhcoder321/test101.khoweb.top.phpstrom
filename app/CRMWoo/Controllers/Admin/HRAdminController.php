...
class HRAdminController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'list' => [
            ...
            ['name' => 'invite_by', 'type' => 'relation', 'label' => 'CRMWoo_admin.nguoi_tuyen', 'object' => 'invite', 'display_field' => 'name', 'sort' => true],
        ],
        'form' => [
            'general_tab' => [
                ...
                /*['name' => 'role_id', 'type' => 'custom', 'field' => 'CRMWoo.hradmin.partials.select_role', 'label' => 'Quyền', 'class' => 'required', 'model' => \App\Models\Roles::class, 'display_field' => 'display_name', 'group_class' => 'col-md-6'],*/
            ...
            'more_info_tab' => [
                ...
                ['name' => 'skype', 'type' => 'text', 'class' => '', 'label' => 'CRMWoo_admin.skype'],
                ['name' => 'zalo', 'type' => 'text', 'class' => '', 'label' => 'zalo'],
                ['name' => 'invite_by', 'type' => 'select2_ajax_model', 'label' => 'CRMWoo_admin.nguoi_tuyen', 'model' => Admin::class, 'object' => 'admin', 'display_field' => 'name', 'display_field2' => 'tel', 'class' => 'required'],
                ['name' => 'room_id', 'type' => 'select', 'options' => [
                    '' => '',
                    1 => 'Phòng kinh doanh 1',
                    2 => 'Phòng kinh doanh 2',
    ...
    protected $filter = [
        ...
        'invite_by' => [
            'label' => 'CRMWoo_admin.nguoi_tuyen',
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMWoo.hradmin.list')->with($data);
    }
    ...
    public function appendWhere($query, $request)
    {
        if($request->status == null) {
            ...
            //  Nếu dùng bộ lọc trạng thái
            if($request->status == 'all') {
                //  lọc theo tất cả trạng thái
            } else {
        ...
        $not_customer = RoleAdmin::whereNotIn('role_id', [3, 4])->pluck('admin_id')->toArray();
        $not_superadmin = RoleAdmin::whereNotIn('role_id', [1, 175, 181])->pluck('admin_id')->toArray();

        $query = $query->whereIn('id', $not_customer)->whereIn('id', $not_superadmin);
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMWoo.hradmin.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMWoo.hradmin.edit')->with($data);
            } else if ($_POST) {
