                            ...
                            <div class="manage-menus">
                                <form method="get" action="{{ $currentUrl }}">
                                    <label for="menu" class="selected-menu">
                                        Chọn menu bạn muốn chỉnh sửa:</label>
                                    ...
                                    <span class="add-new-menu-action"> hoặc <a
                                                href="{{ $currentUrl }}?action=edit&menu=0">Tạo mới menu</a>. </span>
                                </form>
                            </div>
                                            ...
                                            <div id="side-sortables" class="accordion-container">
                                                <ul class="outer-border">
                                                    <li class="control-section accordion-section  open add-page"
                                                        id="add-page">
                                                        <h3 class="accordion-section-title hndle" tabindex="0"> Liên kết
                                                            <span class="screen-reader-text">Nhấn return hoặc enter để mở rộng</span>
                                                        </h3>
                                                                ...
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    ...
                                                                    <p class="button-controls">
                                                                        ...
                                                                        <a href="#" onclick="addcustommenu()"
                                                                           class="button-secondary submit-add-to-menu right">Thêm
                                                                            vào
                                                                            mục menu</a>
                                                        ...
                                                        @elseif(request()->has("menu"))
                                                            <div class="publishing-action">
                                                                <a onclick="getmenus()" name="save_menu"
                                                                   id="save_menu_header"
                                                                   class="button button-primary menu-save">Lưu menu</a>
                                                        ...
                                                        @if(request()->has("menu"))
                                                            ...
                                                            <div class="drag-instructions post-body-plain" style="">
                                                                <p>
                                                                    ...
                                                                    mũi tên bên phải để thiết lập tuỳ chỉnh cho mỗi mục.
                                                                </p>
                                                            </div>
                                                                        ...
                                                                        <dl class="menu-item-bar">
                                                                            <dt class="menu-item-handle">
                                                                                <span class="item-title"> <span
                                                                                            ...
                                                                                            class="is-submenu"
                                                                                            style="@if($m->depth==0)display: none;@endif">Menu con</span> </span>
                                                                                <span class="item-controls"> <span
                                                                                            class="item-type">Liên kết</span> <span
                                                                        ...
                                                                        <div class="menu-item-settings"
                                                                            ...
                                                                            <p class="description description-thin">
                                                                                <label for="edit-menu-item-title-{{$m->id}}">
                                                                                    Nhãn điều hướng<span class="color_btd">*</span>
                                                                                    <br>
                                                                                    <input type="text"
                                                                            ...
                                                                            <p class="field-move hide-if-no-js description description-wide">
                                                                                <label> <span>Di chuyển</span> <a
                                                                                            href="{{ $currentUrl }}"
                                                                                            class="menus-move-up"
                                                                                            style="display: none;">Lên
                                                                                        một bậc</a> <a
                                                                                            href="{{ $currentUrl }}"
                                                                                            class="menus-move-down"
                                                                                            title="Mover uno abajo"
                                                                                            style="display: inline;">Xuống
                                                                                        một bậc</a> <a
                                                                                            href="{{ $currentUrl }}"
                                                                            ...
                                                                            <div class="menu-item-actions description-wide submitbox">
                                                                                ...
                                                                                <a class="item-delete submitdelete deletion"
                                                                                   id="delete-{{$m->id}}"
                                                                                   href="{{ $currentUrl }}?action=delete-menu-item&menu-item={{$m->id}}&_wpnonce=2844002501">Xóa
                                                                                    bỏ</a>
                                                                                <span class="meta-sep hide-if-no-js"> | </span>
                                                                                <a class="item-cancel submitcancel hide-if-no-js button-secondary"
                                                                                   id="cancel-{{$m->id}}"
                                                                                   href="{{ $currentUrl }}?edit-menu-item={{$m->id}}&cancel=1424297719#menu-item-settings-{{$m->id}}">Hủy</a>
                                                                                <span class="meta-sep hide-if-no-js"> | </span>
                                                                                <a onclick="getmenus()"
                                                                                   class="button button-primary updatemenu"
                                                                                   id="update-{{$m->id}}"
                                                                                   href="javascript:void(0)">Cập
                                                                                    nhật</a>
                                                    ...
                                                    <div class="major-publishing-actions">
                                                        ...
                                                        @if(request()->has('action'))
                                                            <div class="publishing-action">
                                                                <a onclick="createnewmenu()" name="save_menu"
                                                                   id="save_menu_header"
                                                                   class="button button-primary menu-save">Tạo menu</a>
                                                            </div>
                                                        @elseif(request()->has("menu"))
