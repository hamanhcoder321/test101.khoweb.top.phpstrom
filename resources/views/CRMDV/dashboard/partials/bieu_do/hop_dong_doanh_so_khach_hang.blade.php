...
<script>
    ...
    $char_hbweb_ky_moi = \App\CRMDV\Models\Bill::selectRaw('Sum(total_price) as total_price, COUNT(id) as total_bill, MONTH(registration_date) as month')
    ...
    $char_hobasoft_ky_moi = \App\CRMDV\Models\Bill::selectRaw('Sum(total_price) as total_price, COUNT(id) as total_bill, MONTH(registration_date) as month')
        ->whereIn('service_id', [
            23, //  web khác
            24,
            25,
    ...
    $admin_ids = \App\Models\RoleAdmin::pluck('admin_id');
    $char_user = \App\Models\User::selectRaw('COUNT(id) as total, MONTH(created_at) as month')
