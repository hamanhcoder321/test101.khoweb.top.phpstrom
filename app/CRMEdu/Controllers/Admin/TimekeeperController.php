...
use App\CRMEdu\Models\Timekeeper;
use Validator;
...
class TimekeeperController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'label' => 'CRMEdu_admin.timekeeper',
        'modal' => '\App\CRMEdu\Models\Timekeeper',
        'list' => [
            ['name' => 'admin_id', 'type' => 'relation_edit', 'label' => 'CRMEdu_admin.timekeeper_name', 'object' => 'admin', 'display_field' => 'name'],
            ['name' => 'admin_id', 'type' => 'relation', 'label' => 'CRMEdu_admin.timekeeper_Ma_NV', 'object' => 'admin', 'display_field' => 'code'],
            ['name' => 'may_cham_cong_id', 'type' => 'text', 'label' => 'CRMEdu_admin.timekeeper_ID'],
            ['name' => 'time', 'type' => 'datetime_vi', 'label' => 'CRMEdu_admin.timekeeper_thime'],
            ['name' => 'thoi_gian_muon', 'type' => 'custom', 'td' => 'CRMEdu.timekeeper.list.td.thoi_gian_muon', 'label' => 'Thời gian muộn'],
            ['name' => 'ly_do_muon', 'type' => 'text', 'label' => 'Lý do muộn'],
            ['name' => 'status', 'type' => 'custom', 'td' => 'CRMEdu.timekeeper.list.td.ly_do_muon', 'label' => 'Cho phép'],
        ],
        'form' => [
            'general_tab' => [
                // ['name' => 'may_cham_cong_id', 'type' => 'number', 'class' => '', 'label' => 'ID máy chấm công', 'group_class' => 'col-md-6'],
                ['name' => 'admin_id', 'type' => 'select2_ajax_model', 'class' => 'required',  'label' => 'CRMEdu_admin.timekeeper_thanh_vien', 'model' => Admin::class, 'object' => 'admin', 'display_field' => 'name', 'display_field2' => 'code', 'group_class' => 'col-md-6'],
                ['name' => 'time', 'type' => 'datetime-local', 'class' => '', 'label' => 'CRMEdu_admin.timekeeper_thoi_gian_cc', 'group_class' => 'col-md-6'],
                ['name' => 'ly_do_muon', 'type' => 'text', 'class' => '', 'label' => 'CRMEdu_admin.timekeeper_ly_do_di_muon', 'group_class' => 'col-md-6'],
                ['name' => 'status', 'type' => 'checkbox', 'label' => 'admin.timekeeper_chap_nhan', 'value' => 1, 'group_class' => 'col-md-6'],
            ],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMEdu.timekeeper.list')->with($data);
    }
    ...
    public function baoCao(Request $request) {
        ...
        return view('CRMEdu.timekeeper.bao_cao')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMEdu.timekeeper.add')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMEdu.timekeeper.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
