            ...
            <div class="kt-widget12__content">
                <div class="kt-widget12__item thong_ke_so">
                    <div class="col-sm-3 kt-widget12__info">
                        ...
                        <?php
                        $val = \App\CRMEdu\Models\BillReceipts::where('price', '<', 0)
                    ...
                    <div class="col-sm-3 kt-widget12__info">
                        <span class="kt-widget12__desc font-vua">Lương Trợ giảng/Giảng viên</span>
                        <?php
                        $val = \App\CRMEdu\Models\BillReceipts::where('price', '<', 0)
                            ->whereRaw("date >= '" . $luong_start_date . "' AND date <= '" . $luong_end_date . "'")
                ...
                <div class="kt-widget12__item thong_ke_so">
                    <div class="col-sm-3 kt-widget12__info">
                        ...
                        <?php
                        $val = \App\CRMEdu\Models\BillReceipts::whereRaw($whereDate)
                            ->where('price', '<', 0)
                            ->whereIn('type', ['co_so'])
                            ->sum('price');
                        ?>
                ...
                <div class="kt-widget12__item thong_ke_so">
                    <div class="col-sm-3 kt-widget12__info">
                        ...
                        <?php
                        $chi_ko_gom_luong = \App\CRMEdu\Models\BillReceipts::where('price', '<', 0)->whereRaw($whereDate)
