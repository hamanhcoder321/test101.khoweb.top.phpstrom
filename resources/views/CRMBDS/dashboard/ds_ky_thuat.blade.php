        ...
        <div class="row">
            ...
            @foreach($ds_dieu_hanh as $admin)
                <?php
                    ...
                    $so_da_dang_lam = App\CRMBDS\Models\BillProgress::leftJoin('bills', 'bills.id', '=', 'bill_progress.bill_id')
                    ...
                    $so_da_da_lam = App\CRMBDS\Models\BillProgress::whereIn('status', [
                                    'Khách xác nhận xong',
                                    'Kết thúc',
                                ])
