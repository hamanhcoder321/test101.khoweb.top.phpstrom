...
$config['licenseName'] = 'thanhhai';
$config['licenseKey'] = '*K?M-*1**-Q**9-*R**-*Y**-5*X*-4**B';
...
$config['backends'][] = array(
    'name' => 'default',
    'adapter' => 'local',
    'baseUrl' => $protocol . $domainName . '/filemanager',
...
$config['resourceTypes'][] = array(
    ...
    'directory' => 'userfiles',
    'maxSize' => 0,
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,docs,doc,xls,mp3',
    'deniedExtensions' => '',
    'backend' => 'default'
);
/*================================ Access Control =====================================*/
