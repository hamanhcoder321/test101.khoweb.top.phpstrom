...
{{--                            </button>--}}
{{--                        </div>--}}
                        <form style="display: flex;align-items: center;justify-content: center;" method="GET" action="">
                            <div class="">
                            ...
                            <div class="kt-portlet__head-actions">
                                <button type="submit" class="btn btn-default btn-icon-sm btn-closed-search">
                                    <i class="la la-search"></i> Tìm kiếm
                                </button>
                            </div>
                        </form>
