                            ...
                            <div class="kt-widget12__content">
                                <div class="kt-widget12__item thong_ke_so">
                                    <div class="col-sm-3 kt-widget12__info">
                                        ...
                                        <span class="kt-widget12__value">{{number_format(@\App\CRMWoo\Models\Bill::whereRaw($whereRegistration)->where(function ($query) use ($nhan_vien_marketing_ids) {
                                ...
                                <div class="kt-widget12__item thong_ke_so">
                                    <div class="col-sm-3 kt-widget12__info">
                                        ...
                                        <?php
                                        $doanh_thu_marketing = \App\CRMWoo\Models\Bill::whereRaw($whereRegistration)->where(function ($query) use ($nhan_vien_marketing_ids) {
                                            foreach ($nhan_vien_marketing_ids as $admin_id) {
                                                $query = $query->orWhere('marketer_ids', 'LIKE', '%|' . $admin_id . '|%');
                                            }
                                        })->sum('total_price');
