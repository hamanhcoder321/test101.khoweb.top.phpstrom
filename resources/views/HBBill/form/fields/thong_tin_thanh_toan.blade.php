        ...
        <div class="kt-portlet__body">
            <div class="kt-section kt-section--first">
                ...
                @if(isset($result))
                    ...
                    <div class="form-group-div form-group {{ @$field['group_class'] }}"
                         id="form-group-{{ $field['name'] }}">
                        <label for="{{ $field['name'] }}">Chưa thanh toán</label>
                        <div class="col-xs-12">
                    ...
                    <div class="form-group-div form-group {{ @$field['group_class'] }}"
                        ...
                        <div class="col-xs-12">
                            <?php
                                $tong_chi = @\App\Modules\HBBill\Models\BillReceipts::where('bill_id', @$result->id)->where('status', 1)->where('price', '<', 0)->sum('price')
                                ?>
