...
class LeadContactedLogController extends CURDBaseController
{

    protected $module = [
        'code' => 'lead',
        'table_name' => 'leads',
        'label' => 'Lịch sử đầu mối',
        'modal' => '\App\CRMDV\Models\Lead',
        'list' => [
            ['name' => 'name', 'type' => 'custom', 'td' => 'CRMDV.lead.list.name', 'label' => 'Tên Khách', 'sort' => true],
            ...
            ['name' => 'contacted_log_last', 'type' => 'custom', 'td' => 'CRMDV.lead.list.contacted_log_last', 'label' => 'Tương tác', 'sort' => true],
        ],
        'form' => [
            'general_tab' => [
                ['name' => 'name', 'type' => 'text', 'class' => 'required', 'label' => 'Tên', 'group_class' => 'col-md-3'],
                ['name' => 'tel', 'type' => 'custom', 'field' => 'CRMDV.lead.form.tel', 'class' => 'required', 'label' => 'SĐT', 'group_class' => 'col-md-3'],
...
//                    'Đã ký HĐ' => 'Đã ký HĐ',
            ...
            'tab_2' => [
                ['name' => 'profile', 'type' => 'textarea_editor', 'label' => 'Chân dung KH', 'group_class' => 'col-md-12', 'inner' => 'rows=5'],
                ['name' => 'need', 'type' => 'textarea_editor', 'label' => 'Nhu cầu & khó khăn', 'group_class' => 'col-md-12', 'inner' => 'rows=5'],
