<div class="kt-portlet kt-portlet--height-fluid">
    ...
    <div class="kt-portlet__body">
        <form method="GET" action="" class="col-xs-12 col-md-12">
            <div class="col-sm-3 col-md-2" style="display: inline-block; float: left;">
                <div>
                    <?php $field = ['name' => 'admin_id', 'type' => 'select', 'class' => '', 'label' => 'Lọc theo vùng',
                       'options' => [
                           'Vùng 1',
                           'Vùng 2',
                           'Vùng 3',
            ...
            <div class="col-sm-3 col-md-2" style="display: inline-block; float: left;">
                <div>
                    <?php $field = ['name' => 'admin_id', 'type' => 'select2_ajax_model', 'class' => '', 'label' => 'Nhân viên',
                        'model' => \App\Models\Admin::class, 'display_field' => 'name', 'object' => 'admin', 'value' => @$_GET['admin_id']];
                    ?>
                    @include(config('core.admin_theme').".form.fields.".$field['type'], ['field' => $field])
                </div>
            </div>
            <div class="col-sm-9 col-md-6" style="display: inline-block; float: left;">
