...
class TPLeadController extends CURDBaseController
{
    ...
    protected $module = [
        'code' => 'lead',
        'table_name' => 'leads',
        'label' => 'CRMEdu_admin.tplead',
        'modal' => '\App\CRMEdu\Models\Lead',
        'list' => [
            ['name' => 'name', 'type' => 'custom', 'td' => 'CRMEdu.lead.list.name', 'label' => 'CRMEdu_admin.tplead_name', 'sort' => true],
            ['name' => 'project', 'type' => 'text', 'label' => 'CRMEdu_admin.tplead_project', 'sort' => true],
            ['name' => 'rate', 'type' => 'custom', 'td' => 'CRMEdu.lead.list.rate', 'label' => 'CRMEdu_admin.tplead_evaluate', 'sort' => true],
            ['name' => 'tel', 'type' => 'custom', 'td' => 'CRMEdu.lead.list.tel', 'label' => 'CRMEdu_admin.tplead_tel', 'sort' => true],
            ['name' => 'service', 'type' => 'select', 'options' => [
                ...
                'game' => 'game',
            ], 'label' => 'CRMEdu_admin.tpdich_vu', 'sort' => true],
            ['name' => 'product', 'type' => 'text', 'label' => 'CRMEdu_admin.tplead_product', 'sort' => true],
            ['name' => 'dating', 'type' => 'custom', 'td' => 'CRMEdu.lead.list.dating', 'label' => 'CRMEdu_admin.tplead_dating', 'sort' => true],
            ['name' => 'contacted_log_last', 'type' => 'custom', 'td' => 'CRMEdu.lead.list.contacted_log_last', 'label' => 'CRMEdu_admin.tplead_last-interaction', 'sort' => true],
        ],
        'form' => [
            'general_tab' => [
                ['name' => 'name', 'type' => 'text', 'class' => 'required', 'label' => 'CRMEdu_admin.tplead_name', 'group_class' => 'col-md-3'],
                ['name' => 'tel', 'type' => 'custom', 'field' => 'CRMEdu.lead.form.tel', 'class' => 'required', 'label' => 'CRMEdu_admin.tplead_tel', 'group_class' => 'col-md-3'],
                ['name' => 'email', 'type' => 'text', 'label' => 'CRMEdu_admin.lead_email', 'group_class' => 'col-md-3'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMEdu.tplead.list')->with($data);
    }
