...
use App\CRMEdu\Models\BillProgressHistory;
...
class DHBillController extends CURDBaseController
{
    ...
    protected $module = [
        'code' => 'dhbill',
        'table_name' => 'bills',
        'label' => 'CRMEdu_admin.dhbill',
        'modal' => '\App\CRMEdu\Models\Bill',
        'list' => [
//            ['name' => 'domain', 'type' => 'text_edit', 'label' => 'Tên miền'],
            ['name' => 'customer_id', 'type' => 'relation', 'label' => 'CRMEdu_admin.khach_hang', 'object' => 'admin', 'display_field' => 'name'],
            ['name' => 'customer_id', 'type' => 'relation', 'label' => 'CRMEdu_admin.dhbill_tel', 'object' => 'admin', 'display_field' => 'tel'],
//            ['name' => 'customer_id', 'type' => 'relation', 'label' => 'Loại khách', 'object' => 'user', 'display_field' => 'classify'],
            ['name' => 'service_id', 'type' => 'custom', 'label' => 'CRMEdu_admin.dhbill_dich_vu', 'td' => 'CRMEdu.dhbill.list.td.service'],
            ['name' => 'progress_id', 'type' => 'relation', 'label' => 'CRMEdu_admin.dhbill_tien_do_du_an', 'object' => 'bill_progress', 'display_field' => 'status'],
            ['name' => 'finance_id', 'type' => 'custom', 'td' => 'CRMEdu.dhbill.list.td.thanh_toan', 'label' => 'CRMEdu_admin.dhbill_pay', 'object' => 'bill_finance', 'display_field' => 'debt'],
            ['name' => 'saler_id', 'type' => 'relation', 'label' => 'CRMEdu_admin.dhbill_business', 'object' => 'saler', 'display_field' => 'name'],
            ['name' => 'progress_id', 'type' => 'relation_through', 'label' => 'CRMEdu_admin.dhbill_tutors', 'object' => 'bill_progress', 'object2' => 'dieu_hanh', 'display_field' => 'name'],
            ['name' => 'progress_id', 'type' => 'relation_through', 'label' => 'CRMEdu_admin.dhbill_lecturers', 'object' => 'bill_progress', 'object2' => 'ky_thuat', 'display_field' => 'name'],
            // ['name' => 'reminder_customer', 'type' => 'custom', 'td' => 'CRMEdu.dhbill.list.td.reminder_customer', 'label' => 'Deadline', 'sort' => true],
            ['name' => 'registration_date', 'type' => 'date_vi', 'label' => 'CRMEdu_admin.dhbill_contract_signing_date', 'sort' => true],
            ['name' => 'rate_content', 'type' => 'custom', 'td' => 'CRMEdu.dhbill.list.td.rate_content', 'label' => 'CRMEdu_admin.dhbill_evaluate', 'sort' => true],

        ],
        'form' => [
            'general_tab' => [
                
                ['name' => 'domain', 'type' => 'text', 'label' => 'CRMEdu_admin.dhbill_Domain', 'class' => ' required', 'group_class' => 'col-md-3'],
                ['name' => 'service_id', 'type' => 'select2_model', 'class' => ' required',  'label' => 'CRMEdu_admin.dhbill_Goi_DV', 'model' => Service::class, 'display_field' => 'name_vi', 'group_class' => 'col-md-6', 'inner' => 'disabled'],
                ['name' => 'registration_date', 'type' => 'date', 'label' => 'CRMEdu_admin.dhbill_Ngay_ki_HD', 'class' => 'required', 'group_class' => 'col-md-3', 'inner' => 'disabled'],
                ['name' => 'customer_note', 'type' => 'textarea', 'class' => 'required', 'label' => 'CRMEdu_admin.dhbill_Ghi_chu_KH'],
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMEdu.dhbill.list')->with($data);
    }
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMEdu.dhbill.edit')->with($data);
            }
