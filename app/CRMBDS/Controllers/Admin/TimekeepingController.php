...
class TimekeepingController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'label' => 'CRMBDS_admin.timekeepings',
        'modal' => '\App\CRMBDS\Models\Timekeeping',
        'list' => [
            ['name' => 'day', 'type' => 'date_vi', 'label' => 'CRMBDS_admin.timekeepings_date', 'sort' => true],
            ['name' => 'time', 'type' => 'text', 'label' => 'CRMBDS_admin.timekeepings_time', 'sort' => true],
            ['name' => 'created_at', 'type' => 'datetime_vi', 'label' => 'CRMBDS_admin.timekeepings_Tao', 'sort' => true],
            ['name' => 'status', 'type' => 'status', 'label' => 'CRMBDS_admin.timekeepings_Pay', 'sort' => true],
        ],
        'form' => [
            'general_tab' => [
            ...
            'tab_2' => [
                ...
                ['name' => 'saler_id', 'type' => 'custom', 'field' => 'CRMBDS.timekeeping.form.fields.select_admin', 'label' => 'Sale', 'model' => Admin::class, 'object' => 'admin', 'display_field' => 'name', 'display_field2' => 'code', 'class' => 'required'],
                ['name' => 'job_other', 'type' => 'textarea', 'label' => 'CRMBDS_admin.timekeepings_Cong_viec_khac', 'group_class' => 'col-md-12', 'inner' => 'rows=15'],
    ...
    protected $filter = [
        'admin_id' => [
            'label' => 'CRMBDS_admin.timekeepings_Nguoi_tao',
        ...
        'status' => [
            'label' => 'CRMBDS_admin.timekeepings_Status_Pay',
            'type' => 'select',
            'options' => [
                '' => 'Tất cả',
                0 => 'Chưa thanh toán',
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMBDS.timekeeping.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMBDS.timekeeping.add')->with($data);
            } else if ($_POST) {
                ...
                if ($validator->fails()) {
                    ...
                    $logs = [];
                    $lead_contacted_logs = \App\CRMBDS\Models\LeadContactedLog::select('lead_id', 'note', 'created_at')->where('admin_id', \Auth::guard('admin')->user()->id)
                    ...
                    $leads = \App\CRMBDS\Models\Lead::select('tel', 'name', 'created_at')->where('admin_id', \Auth::guard('admin')->user()->id)
                        ->where('created_at', '>=', date('Y-m-d 00:00:00', strtotime($data['day'])))
                        ->where('created_at', '<=', date('Y-m-d 23:59:59', strtotime($data['day'])))->orderBy('id', 'asc')->get();
                    foreach($leads as $v) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMBDS.timekeeping.edit')->with($data);
            } else if ($_POST) {
    ...
    public function view(Request $request) {
        ...
        $data = $this->getDataUpdate($request, $item);
        return view('CRMBDS.timekeeping.view')->with($data);
    }
    ...
    public function show()
    {
        ...
        $data['page_type'] = 'list';
        return view('CRMBDS.timekeeping.show')->with($data);
    }
    ...
    public function tooltipInfo(Request $r) {
        ...
        return view('CRMBDS.timekeeping.tooltip_info')->with($data);
    }
    ...
    public function sendMail() {
        ...
        if ($settings['admin_receives_mail'] == 1) {
            ...
            foreach ($admins as $admin) {
                ...
                $data = [
                    'view' => 'CRMBDS.timekeeping.emails.tien_do_cong_viec',
