...
class CRMDVServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        // API routes
        Route::prefix('api/v0/crmdv')
            ->middleware('api')
            ->group(base_path('app/CRMDV/routes/api.php'));

        // Web routes
        Route::middleware('web')
            ->group(base_path('app/CRMDV/routes/web.php'));
    }
...
//        CrawlWeb::class,
    ...
    {
        \Eventy::addFilter('aside_menu.dashboard_after', function ($content) {
            return $content . view('CRMDV.partials.aside_menu.menu_left');
        }, 1, 1);
    }
}
