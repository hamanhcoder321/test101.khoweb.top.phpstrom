            ...
            <div class="kt-widget12__content">
                <div class="kt-widget12__item thong_ke_so">
                    <div class="col-sm-3 kt-widget12__info">
                        ...
                        <?php
                        $val = \App\CRMBDS\Models\BillReceipts::where('price', '<', 0)
                ...
                <div class="kt-widget12__item thong_ke_so">
                    <div class="col-sm-3 kt-widget12__info">
                        ...
                        <?php
                        $val = \App\CRMBDS\Models\BillReceipts::whereRaw($whereDate)
                            ->where('price', '<', 0)
                            ->whereIn('type', ['co_so'])
                            ->sum('price');
                        ?>
                ...
                <div class="kt-widget12__item thong_ke_so">
                    <div class="col-sm-3 kt-widget12__info">
                        ...
                        <?php
                        $chi_ko_gom_luong = \App\CRMBDS\Models\BillReceipts::where('price', '<', 0)->whereRaw($whereDate)
