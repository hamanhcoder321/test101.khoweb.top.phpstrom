                ...
                <div class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--scroll kt-datatable--loaded"
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($listItem as $item)
                            ...
                            <?php 
                                $childs1 = \App\CRMBDS\Models\Category::where('parent_id', $item->id)->orderBy('order_no', 'desc')->orderBy('name', 'asc')->get();
                            ?>
                            @foreach($childs1 as $item)
                                ...
                                <?php 
                                    $childs2 = \App\CRMBDS\Models\Category::where('parent_id', $item->id)->orderBy('order_no', 'desc')->orderBy('name', 'asc')->get();
                                ?>
