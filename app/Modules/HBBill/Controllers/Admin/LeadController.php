...
use Validator;
use App\Modules\HBBill\Models\LeadContactedLog;
use App\Modules\HBBill\Models\Lead;
...
class LeadController extends CURDBaseController
{
    ...
    protected $module = [
        ...
        'table_name' => 'leads',
        'label' => 'Đầu mối',
        'modal' => '\App\Modules\HBBill\Models\Lead',
        'list' => [
            ['name' => 'name', 'type' => 'custom', 'td' => 'HBBill.lead.list.name', 'label' => 'Tên', 'sort' => true],
            ['name' => 'product', 'type' => 'text', 'label' => 'SP', 'sort' => true],
            ['name' => 'project', 'type' => 'text', 'label' => 'Dự án', 'sort' => true],
            ['name' => 'rate', 'type' => 'custom', 'td' => 'HBBill.lead.list.rate', 'label' => 'Đánh giá', 'sort' => true],
            ['name' => 'tel', 'type' => 'custom', 'td' => 'HBBill.lead.list.tel', 'label' => 'SĐT', 'sort' => true],
            ...
            ['name' => 'dating', 'type' => 'custom', 'td' => 'HBBill.lead.list.dating', 'label' => 'Hẹn ngày', 'sort' => true],
            ['name' => 'contacted_log_last', 'type' => 'custom', 'td' => 'HBBill.lead.list.contacted_log_last', 'label' => 'TT lần cuối', 'sort' => true],
        ],
        'form' => [
            'general_tab' => [
                ['name' => 'name', 'type' => 'text', 'class' => 'required', 'label' => 'Tên', 'group_class' => 'col-md-3'],
                ['name' => 'tel', 'type' => 'custom', 'field' => 'HBBill.lead.form.tel', 'class' => 'required', 'label' => 'SĐT', 'group_class' => 'col-md-3'],
...
//                ], 'label' => 'Đánh giá', 'group_class' => 'col-md-3'],
                ['name' => 'rate', 'type' => 'select2_model', 'label' => 'Đánh giá', 'model' => Tag::class, 'group_class' => 'col-md-3',
...
//                ->where('dating', '<=', date('Y-m-d 23:59:59'));
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('HBBill.lead.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('HBBill.lead.add')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('HBBill.lead.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
    ...
    public function view(Request $request) {
        ...
        $data = $this->getDataUpdate($request, $item);
        return view('HBBill.lead.view')->with($data);
    }
    ...
    public function show()
    {
        ...
        $data['page_type'] = 'list';
        return view('HBBill.lead.show')->with($data);
    }
    ...
    public function tooltipInfo(Request $r) {
        ...
        return view('HBBill.lead.tooltip_info')->with($data);
    }
    ...
    public function sendMail() {
        ...
        if ($settings['admin_receives_mail'] == 1) {
            ...
            foreach ($admins as $admin) {
                ...
                $data = [
                    'view' => 'HBBill.lead.emails.tien_do_cong_viec',
    ...
    public function checkExist(Request $request) {
        ...
        if ($request->has('tel')) {
            ...
            $customer = \App\Modules\HBBill\Models\Admin::select('id', 'email', 'name', 'tel', 'created_at', 'sale_id')->where('tel', $request->tel)->first();
            if (is_object($customer)) {
    ...
    public function dashboard(Request $r) {
        ...
        return view('HBBill.lead.dashboard.dashboard', $data);
    }
}
