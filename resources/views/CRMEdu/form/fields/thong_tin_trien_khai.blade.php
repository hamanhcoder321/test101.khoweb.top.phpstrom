    ...
    <div class="kt-form">
        <div class="kt-portlet__body">
            <div class="kt-section kt-section--first">
                ...
                <?php
                $field = ['name' => 'progress_rate_content', 'type' => 'text', 'label' => 'Đánh giá lớp học', 'class' => '', 'group_class' => 'col-md-9 required', 'value' => isset($result) ? @$result->bill_progress->rate_content : '', ];
                ?>
                <div class="form-group-div form-group {{ @$field['group_class'] }}"
                     id="form-group-{{ $field['name'] }}">
                    <label for="{{ $field['name'] }}">{{ @$field['label'] }} @if(strpos(@$field['class'], 'require') !== false)
                ...
                <div class="form-group-div form-group {{ @$field['group_class'] }}"
                    ...
                    <label for="{{ $field['name'] }}">{{ @$field['label'] }} @if(strpos(@$field['class'], 'require') !== false)
                        ...
                        @endif</label>
                    <div class="col-xs-12">
                        @include('CRMEdu.form.partials.select_dieu_hanh', ['field' => $field])
                        <span class="text-danger">{{ $errors->first($field['name']) }}</span>
                    </div>
                </div>
                ...
                <div class="form-group-div form-group {{ @$field['group_class'] }}"
                    ...
                    <label for="{{ $field['name'] }}">{{ @$field['label'] }} @if(strpos(@$field['class'], 'require') !== false)
                        ...
                        @endif</label>
                    <div class="col-xs-12">
                        @include('CRMEdu.form.partials.select_ky_thuat', ['field' => $field])
                        <span class="text-danger">{{ $errors->first($field['name']) }}</span>
                    </div>
                </div>
            ...
            @include("CRMEdu.dhbill.partials.lich_su_trang_thai")
        </div>
    </div>
    <!--end::Form-->
</div>
