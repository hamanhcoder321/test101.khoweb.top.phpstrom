...
class CourseController extends CURDBaseController
{
    ...
    protected $module = [
        'code' => 'course',
        'table_name' => 'courses',
        'label' => 'CRMBDS_admin.courses',
        'modal' => '\App\CRMBDS\Models\Course',
        'list' => [
            ['name' => 'name', 'type' => 'text_edit', 'label' => 'CRMBDS_admin.courses_title', 'sort' => true],
            ['name' => 'author_name', 'type' => 'text', 'label' => 'CRMBDS_admin.courses_author', 'sort' => true],
            ['name' => 'link1', 'type' => 'link', 'label' => 'CRMBDS_admin.courses_Link', 'sort' => true],
            ['name' => 'level', 'type' => 'text', 'label' => 'CRMBDS_admin.courses_Level', 'sort' => true],
            ['name' => 'status', 'type' => 'status', 'label' => 'CRMBDS_admin.courses_status'],
        ],
        'form' => [
            'general_tab' => [
                ['name' => 'name', 'type' => 'text', 'class' => 'required', 'label' => 'CRMBDS_admin.courses_Tieu_de', 'group_class' => 'col-md-6'],
                ['name' => 'author_name1', 'type' => 'text', 'class' => '', 'label' => 'CRMBDS_admin.courses_name_author', 'group_class' => 'col-md-6'],
                ['name' => 'link', 'type' => 'text', 'label' => 'CRMBDS_admin.courses_duong_link',  'group_class' => 'col-md-9'],
                ['name' => 'order_no', 'type' => 'number', 'class' => 'required', 'label' => 'CRMBDS_admin.courses_order', 'group_class' => 'col-md-3', 'value' => 1],
                ['name' => 'multi_cat', 'type' => 'custom', 'field' => 'CRMBDS.form.fields.multi_cat', 'label' => 'CRMBDS_admin.courses_duong_link', 'model' => Category::class,
                    'object' => 'category_course', 'where' => 'type in (1)', 'display_field' => 'name', 'multiple' => true, 'group_class' => 'col-md-8'],
                ['name' => 'status', 'type' => 'checkbox', 'label' => 'CRMBDS_admin.courses_display', 'value' => 1, 'group_class' => 'col-md-4'],
    ...
    public function view(Request $request, $id)
    {
        ...
        return view('CRMBDS.course.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMBDS.course.add')->with($data);
            } else if ($_POST) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            if (!$_POST) {
                ...
                return view('CRMBDS.course.edit')->with($data);
            } else if ($_POST) {
                \DB::beginTransaction();
