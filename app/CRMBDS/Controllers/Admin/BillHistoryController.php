...
class BillHistoryController extends CURDBaseController
{
    ...
    protected $module = [
        'code' => 'bill_histories',
        'table_name' => 'bills',
        'label' => 'CRMBDS_admin.bill_histories',
        'modal' => '\App\CRMBDS\Models\Bill',
        'list' => [
            ['name' => 'registration_date', 'type' => 'date_vi', 'label' => 'CRMBDS_admin.bill_histories_date'],
            ['name' => 'service_id', 'type' => 'relation', 'label' => 'CRMBDS_admin.bill_histories_service', 'object' => 'service', 'display_field' => 'name_vi', 'sort' => true],
            ['name' => 'total_price', 'type' => 'price_vi', 'label' => 'CRMBDS_admin.bill_histories_money'],
            ['name' => 'note', 'type' => 'text', 'label' => 'CRMBDS_admin.bill_histories_N'],
        ],
        'form' => [
            'general_tab' => [
                ['name' => 'registration_date', 'type' => 'date', 'class' => 'required', 'label' => 'CRMBDS_admin.bill_histories_extension'],
                ['name' => 'total_price', 'type' => 'price_vi','label' => 'CRMBDS_admin.bill_histories_payment_amount'],
                ...
                ['name' => 'note', 'type' => 'textarea', 'class' => '', 'label' => 'CRMBDS_admin.bill_histories_Note'],
            ],
        ],
    ];
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('CRMBDS.bill_history.list')->with($data);
    }
    ...
    public function add(Request $request)
    {
        try {
            if (!$_POST) {
                ...
                return view('CRMBDS.bill_history.add')->with($data);
            } else if ($_POST) {
//                dd($request->all());
...
//            }
        ...
        if (!$_POST) {
            ...
            return view('CRMBDS.bill_history.edit')->with($data);
        } else if ($_POST) {
            $validator = Validator::make($request->all(), [
                'value' => 'required'
            ], [
